...
public class AdminLoginPanel extends JPanel {
    ...
    public AdminLoginPanel(MainFrame properMainFrame) {
        ...
        JLabel textLabel = new JLabel("Please provide administrator data below",SwingConstants.CENTER);
        ...
        JButton login = new ValidateUserLoginButton(this.properMainFrame, username,password, "A");
